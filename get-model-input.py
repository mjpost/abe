...
LLAMA_LIST = ["meta-llama/Llama-3.2-1B-Instruct/0-SHOT", "meta-llama/Llama-3.2-3B-Instruct/0-SHOT", "meta-llama/Llama-3.1-8B-Instruct/0-SHOT"]
LLAMA_THREE_SHOT_LIST = ["meta-llama/Llama-3.2-1B-Instruct/3-SHOT", "meta-llama/Llama-3.2-3B-Instruct/3-SHOT", "meta-llama/Llama-3.1-8B-Instruct/3-SHOT"]
...
if model_name in TOWER_LIST:
    ...
    print(f"input_data/{testset}.{language_pair}.{source_lang}.llama3-zero-shot.json")
elif model_name in LLAMA_THREE_SHOT_LIST:
    print(f"input_data/{testset}.{language_pair}.{source_lang}.llama3-three-shot.json")
