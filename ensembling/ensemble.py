...
def ensemble_beam_search(
    ...
    def compatible(cand1, cand2) -> bool:
        """
        Input string: cand1, cand2
        Returns: 
        -1 if cand1 is shorter and is a substring of cand2
        1 if cand2 is shorter and is a substring of cand1
        0 if they are equal

        Surface string is the string that is generated by the model upto the current token (candidate)

        Don't think it is used in the current implementation. Can be removed while refactoring. 
        """
